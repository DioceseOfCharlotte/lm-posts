<?php
/*
Plugin Name: Lay Ministry Post Types
Plugin URI: https://github.com/DioceseOfCharlotte/lm-cpts
...
Text Domain: lm
GitHub Plugin URI: https://github.com/DioceseOfCharlotte/lm-cpts
*/
...
final class LM_Posts_Plugin {
	...
	public function admin_scripts() {
		...
		wp_enqueue_style( 'lm-admin-styles', $this->css_uri . 'lm.css' );
	 ...
	 * @return array
	 */
	public function lm_get_capabilities( $name ) {
		...
		return apply_filters( 'lm_get_capabilities', $caps );
	}

	public function activation() {

		$this->lm_get_capabilities( $name );
		lm_register_post_types();
		//lm_register_taxonomies();
		$this->add_roles();
 ...
 * @return object
 */
function lm_posts_plugin() {
	return LM_Posts_Plugin::get_instance();
}
